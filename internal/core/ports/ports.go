...
type JobRepository interface {
	...
	ListJobsByAgent(ctx context.Context, agentID string, offset, limit int) ([]*domain.Job, error)
	CountJobs(ctx context.Context) (int64, error)
	CountJobsByAgent(ctx context.Context, agentID string) (int64, error)
	CountActiveJobsByAgent(ctx context.Context, agentID string) (int64, error)
}
